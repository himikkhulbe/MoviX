              ...
              <div className="p-3 text-white max-h-[18vh] overflow-y-auto">
                ...
                <p className="text-sm font-light">
                  {d?.overview ? (
                    ...
                    <span className=" ">Known for : <span className="font-semibold">{d?.known_for_department}</span></span>
                  )}
                  
                  {d?.overview && <span className="text-zinc-400 hover:text-zinc-500 duration-100">
                    ...more
                  </span>}
