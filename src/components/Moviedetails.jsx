...
const Moviedetails = () => {
  document.title = "MoviX | Movie Details";
  ...
  return info ? (
    <div
      style={{
        background: `linear-gradient(rgba(0,0,0,0.12),rgba(0,0,0,0.7),rgba(0,0,0,0.6)), url(https://image.tmdb.org/t/p/original/${info.detail.backdrop_path}`,
    ...
    >
        ...
        <div className="content ml-10 text-white flex flex-col justify-between">
          <div>
            ...
            <div className="flex text-white items-center gap-5 font-normal text-lg">
              ...
              <span>{info.detail.runtime} mins</span>
            </div>
      ...
      <div className="mt-5 flex items-start gap-[20vh]">
        ...
        >
          ...
          <Outlet />
        </div> : <h1 className="text-3xl mr-[35%] text-white font-semibold text-nowrap text-center mt-10">No Recommendations Available</h1>}
